...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    // Placed the 3 variables outside of the for loop in order to achieve the sub-5ms time to resize
    // pizzas. The RandomPizzas variable is a collection of all the randomPizzaContainer elements.
...
function updatePositions() {
  // To optimize this function, I followed the advice in a helpful post by mcs which can be found here:
